...
namespace FlowCanvas.Nodes{
	...
	abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6, T7> : CallableActionNode{
	...
	abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6, T7, T8> : CallableActionNode{
	...
	abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6, T7, T8, T9> : CallableActionNode{
	...
	abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : CallableActionNode{
