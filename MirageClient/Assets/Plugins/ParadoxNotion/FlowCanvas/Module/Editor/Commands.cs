...
namespace FlowCanvas.Editor{
	...
	static class Commands {
		...
		//Graphs
		[MenuItem("Tools/ParadoxNotion/FlowCanvas/Create/FlowScript", false, 1)]
		public static void CreateFlowScript(){
			var newFS = EditorUtils.CreateAsset<FlowScript>(true);
			Selection.activeObject = newFS;
		}

		[MenuItem("Assets/Create/ParadoxNotion/FlowCanvas/FlowScript")]
		...
		[MenuItem("Tools/ParadoxNotion/FlowCanvas/Create/Macro", false, 1)]
		public static void CreateMacro(){
			var macro = EditorUtils.CreateAsset<Macro>(true);
			Selection.activeObject = macro;
		}

		[MenuItem("Assets/Create/ParadoxNotion/FlowCanvas/Macro")]
